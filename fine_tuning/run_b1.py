...
B1_ALLOWED_TREE_CHANGES = {
    ...
    "fine_tuning/competitive_gate.py",
    "fine_tuning/competitive_gate_manifest.json",
    "fine_tuning/second_setting.py",
    "fine_tuning/second_setting_manifest.json",
